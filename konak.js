...
const Konak_ = {
  ...
  ciz(g, Y, opts){
    ...
    this.cizDegnek(g, Y);
    this.cizKiler(g, Y);
    /* HAK SATIRI ARTIK BURADA CIZILMIYOR (2026-08-21). Konak katmani
       agilin USTUNE biniyor ve agilin ust bandinda zaten uc satir var
       (durum / siradaki ne / gunun kurali). Dorduncu satir cakisti —
       BASILDI, GORULDU: kural yazisi 'HOURS LEFT' satirinin ustune
       bindi.

       Cozum tasimak degil BIRLESTIRMEK: agilin "siradaki ne" satiri
       durak gununde zaten 'is hakkini harca' diyordu, yani ayni seyi
       iki kez soyluyorduk. Simdi o satirin kendisi kac saat kaldigini
       soyluyor (bkz. foldSiradaki). Tek satir, daha fazla bilgi. */
